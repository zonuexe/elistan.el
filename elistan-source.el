...
(defconst elistan-source--fallback
  '((stringp        . (function (t) (:guard! string)))
    ...
    (arrayp         . (function (t) (:guard! array)))
    (sequencep      . (function (t) (:guard! sequence)))
    (characterp     . (function (t) (:guard! character)))
    (markerp        . (function (t) (:guard! marker)))
    (recordp        . (function (t) (:guard! record)))
    (framep         . (function (t) (:guard! frame)))
    (windowp        . (function (t) (:guard! window)))
    (processp       . (function (t) (:guard! process)))
    (overlayp       . (function (t) (:guard! overlay)))
